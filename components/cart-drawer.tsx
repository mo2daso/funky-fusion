...
export function CartDrawer({ isOpen, onClose }: CartDrawerProps) {
  const { cartItems, removeFromCart, updateQuantity, getCartTotal, getSubtotal, getDeliveryCost } = useCart()
              ...
              <>
                ...
                <div className="border-t border-gray-200 dark:border-gray-700 px-4 py-6 sm:px-6">
                  ...
                  <div className="flex justify-between text-base font-medium mb-4">
                    <p>Delivery</p>
                    <p>Rs. {getDeliveryCost()}</p>
                  </div>
                  <div className="flex justify-between text-base font-medium mb-4 pt-2 border-t dark:border-gray-700">
                    <p>Total</p>
                    <p>Rs. {getCartTotal()}</p>
                  </div>
                  <p className="text-sm text-gray-500 dark:text-gray-400 mb-6">Taxes calculated at checkout.</p>
